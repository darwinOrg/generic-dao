...
public enum ColumnBuilder {
  ...
  MAX {
    public String build(String field) {
      return Utils.concat("max(", field, ") as ", field);
    }
  },
  MIN {
    public String build(String field) {
      return Utils.concat("min(", field, ") as ", field);
    }
  },
  SUM {
    public String build(String field) {
      return Utils.concat("sum(", field, ") as ", field);
    }
  },
  AVG {
    public String build(String field) {
      return Utils.concat("avg(", field, ") as ", field);
    }
  },
  DISTINCT {
    public String build(String field) {
      return Utils.concat("distinct ", field);
    }
  };
